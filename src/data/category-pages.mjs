...
const CATEGORY_PAGES = {
  'Música': { slug: 'musica', h1: 'Conciertos y música en Valladolid', h2: 'Toda la agenda de música en directo', description: 'Agenda de conciertos y música en directo en Valladolid: todos los próximos eventos musicales recopilados por la comunidad de Aldea Pucela.' },
  ...
  'Exposición': { slug: 'exposiciones', h1: 'Exposiciones en Valladolid', h2: 'Muestras y exposiciones de arte', description: 'Agenda de exposiciones en Valladolid: muestras de arte, fotografía y más, recopiladas por la comunidad de Aldea Pucela.' },
  'Libros': { slug: 'presentaciones-de-libros', h1: 'Presentaciones de libros en Valladolid', h2: 'Novedades literarias y encuentros con autores', description: 'Agenda de presentaciones de libros en Valladolid: novedades y encuentros con autores recopilados por la comunidad de Aldea Pucela.' },
  ...
  'Ferias y mercados': { slug: 'ferias-y-mercados', h1: 'Ferias y mercados en Valladolid', h2: 'Mercadillos, ferias y mercados', description: 'Agenda de ferias y mercados en Valladolid: mercadillos y ferias recopilados por la comunidad de Aldea Pucela.' },
  ...
  'Cine': { slug: 'cine', h1: 'Cine en Valladolid', h2: 'Proyecciones, ciclos y estrenos', description: 'Agenda de cine en Valladolid: proyecciones, ciclos y estrenos recopilados por la comunidad de Aldea Pucela.' },
  'Infantil y familia': { slug: 'infantil-y-familia', h1: 'Planes infantiles y en familia en Valladolid', h2: 'Actividades para peques y familias', description: 'Agenda infantil y en familia en Valladolid: talleres, espectáculos y planes para peques recopilados por la comunidad de Aldea Pucela.' },
  ...
  'Magia y circo': { slug: 'magia-y-circo', h1: 'Magia y circo en Valladolid', h2: 'Espectáculos de magia y circo', description: 'Agenda de magia y circo en Valladolid: todas las próximas funciones recopiladas por la comunidad de Aldea Pucela.' },
